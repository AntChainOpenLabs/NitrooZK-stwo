...
use crate::core::{backend::simd::qm31, fields::qm31::SecureField};
use crate::core::backend::simd::very_packed_m31::VeryPackedSecureField;
...
impl SecureFieldVec {
    ...
    pub fn from_vec(host_array: Vec<SecureField>) -> Self {
        let data_size_bytes = (host_array.len() * 16) as u64;
        ...
        // println!("PCIe transfer (Host to Device) speed: {:.2} GB/s", transfer_speed_gbps);
