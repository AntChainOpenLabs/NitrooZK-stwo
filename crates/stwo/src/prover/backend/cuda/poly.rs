...
impl PolyOps for CudaBackend {
    ...
    fn interpolate_columns(
        ...
        // Fall back to sequential - batch NTT requires all columns to have identical domains
        // In the current prover workload, columns have varying sizes (e.g., 7, 1006, 1180)
        // so batch optimization cannot be applied
        columns
            .into_iter()
    ...
    fn evaluate_polynomials(
        ...
        // Fall back to sequential - batch NTT requires all polynomials to have identical sizes
        // In the current prover workload, polynomials have varying sizes
        // so batch optimization cannot be applied
