...
extern "C" {
    ...
    pub fn poseidon252_lifted_build_next_layer(
        size: u32,
        prev_layer: *const [u8; 32],
        result: *mut [u8; 32],
    );

    pub fn poseidon252_alloc_init_states(count: u32) -> *mut c_void;

    pub fn poseidon252_lift_states(
        prev_states: *mut c_void,
        prev_size: u32,
        next_states_out: *mut *mut c_void,
        next_size: u32,
    ...
    pub fn poseidon252_update_columns(
        states: *mut c_void,
        size: u32,
        column_ptrs_host: *const *const u32,
        num_columns: u32,
    ...
    pub fn poseidon252_build_leaves_fused(
        size: usize,
        number_of_columns: usize,
        device_columns: *const *const u32,
        result: *mut [u8; 32],
