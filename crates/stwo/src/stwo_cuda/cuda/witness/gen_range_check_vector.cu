...
void range_check_vector_generate_interaction_trace(
    ...
    if (n_range == 1) {
        HANDLE_RANGE_CHECK(RangeCheck_6, 1, ranges[0] == 6)
        HANDLE_RANGE_CHECK(RangeCheck_8, 1, ranges[0] == 8)
        HANDLE_RANGE_CHECK(RangeCheck_11, 1, ranges[0] == 11)
        HANDLE_RANGE_CHECK(RangeCheck_12, 1, ranges[0] == 12)
        HANDLE_RANGE_CHECK(RangeCheck_18, 1, ranges[0] == 18)
        HANDLE_RANGE_CHECK(RangeCheck_19, 1, ranges[0] == 19)
    } else if (n_range == 2) {
        HANDLE_RANGE_CHECK(RangeCheck_3_6, 2, ranges[0] == 3 && ranges[1] == 6)
        HANDLE_RANGE_CHECK(RangeCheck_4_3, 2, ranges[0] == 4 && ranges[1] == 3)
        HANDLE_RANGE_CHECK(RangeCheck_4_4, 2, ranges[0] == 4 && ranges[1] == 4)
        HANDLE_RANGE_CHECK(RangeCheck_5_4, 2, ranges[0] == 5 && ranges[1] == 4)
        HANDLE_RANGE_CHECK(RangeCheck_9_9, 2, ranges[0] == 9 && ranges[1] == 9)
    } else if (n_range == 3) {
        HANDLE_RANGE_CHECK(RangeCheck_7_2_5, 3, ranges[0] == 7 && ranges[1] == 2 && ranges[2] == 5)
    } else if (n_range == 4) {
        HANDLE_RANGE_CHECK(RangeCheck_3_6_6_3, 4, ranges[0] == 3 && ranges[1] == 6 && ranges[2] == 6 && ranges[3] == 3)
        HANDLE_RANGE_CHECK(RangeCheck_4_4_4_4, 4, ranges[0] == 4 && ranges[1] == 4 && ranges[2] == 4 && ranges[3] == 4)
    } else if (n_range == 5) {
        HANDLE_RANGE_CHECK(RangeCheck_3_3_3_3_3, 5, ranges[0] == 3 && ranges[1] == 3 && ranges[2] == 3 && ranges[3] == 3 && ranges[4] == 3)
    }
