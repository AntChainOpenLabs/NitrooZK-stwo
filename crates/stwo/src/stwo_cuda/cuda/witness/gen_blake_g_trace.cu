...
__global__ void generate_blake_g_trace_kernel(
    ...
    if (row < trace_size) {
        ...
        sub_component_inputs_verify_bitwise_xor_8[2 * 3 ][row] = split_16_low_part_size_8_output_tmp_f72c8_7_0;
        sub_component_inputs_verify_bitwise_xor_8[2 * 3 + 1][row] = split_16_low_part_size_8_output_tmp_f72c8_11_0;
        sub_component_inputs_verify_bitwise_xor_8[2 * 3 + 2][row] = xor_col20;
        ...
        sub_component_inputs_verify_bitwise_xor_8[3 * 3 + 0][row] = ms_8_bits_col15;
        sub_component_inputs_verify_bitwise_xor_8[3 * 3 + 1][row] = ms_8_bits_col17;
        sub_component_inputs_verify_bitwise_xor_8[3 * 3 + 2][row] = xor_col21;
        ...
        sub_component_inputs_verify_bitwise_xor_8[4 * 3 + 0][row] = split_16_low_part_size_8_output_tmp_f72c8_49_0;
        sub_component_inputs_verify_bitwise_xor_8[4 * 3 + 1][row] = split_16_low_part_size_8_output_tmp_f72c8_53_0;
        sub_component_inputs_verify_bitwise_xor_8[4 * 3 + 2][row] = xor_col38;
        ...
        sub_component_inputs_verify_bitwise_xor_8[5 * 3 + 0][row] = ms_8_bits_col34;
        sub_component_inputs_verify_bitwise_xor_8[5 * 3 + 1][row] = ms_8_bits_col36;
        sub_component_inputs_verify_bitwise_xor_8[5 * 3 + 2][row] = xor_col39;
...
void generate_blake_g_interaction_traces(
    ...
    // #4 Interaction trace For verify_bitwise_xor_8_4 & verify_bitwise_xor_8_5
    block_dim = trace_size < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_blake_g_interaction_trace_col_gen_kernel<3, 3><<<num_blocks, block_dim>>>(
        device_verify_bitwise_xor_8_lookup_elements,
    ...
    // #5 Interaction trace For verify_bitwise_xor_8_6 & verify_bitwise_xor_8_7
    block_dim = trace_size < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_blake_g_interaction_trace_col_gen_kernel<3, 3><<<num_blocks, block_dim>>>(
        device_verify_bitwise_xor_8_lookup_elements,
    ...
    // #8 Interaction trace For blake_g_0
    block_dim = trace_size < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < BLAKE_G_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
