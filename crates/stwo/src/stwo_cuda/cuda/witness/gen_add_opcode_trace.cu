...
#include "gen_add_opcode_trace.cuh"
#include "gen_memory_address_to_id_trace.cuh"
#include "gen_memory_id_to_big_trace.cuh"

#define ADD_OPCODE_N_TRACE_COLUMNS 103

#define ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS 5

__launch_bounds__(256, 2)
__global__ void generate_add_opcode_trace_kernel(
    m31 **traces,
    ...
    if (row < trace_size) {
        m31 input_pc_col0 = add_opcode_inputs[0][row];
        traces[0][row] = input_pc_col0;
        m31 input_col1 = add_opcode_inputs[1][row];
        traces[1][row] = input_col1;
        m31 input_fp_col2 = add_opcode_inputs[2][row];
        traces[2][row] = input_fp_col2;
        Enabler enabler_col = Enabler(trace_size);

        // Decode Instruction
        m31 memory_address_to_id_value_tmp_3fa46_0 = {0};
        ...
        uint16_t offset0_tmp_3fa46_2 =
            ...
            + ((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[1]) & UInt16_127)) << UInt16_9);
        m31 offset0_col3 = m31{offset0_tmp_3fa46_2};
        traces[3][row] = offset0_col3;
        // offset1
        uint16_t offset1_tmp_3fa46_3 =
            (((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[1])) >> UInt16_7)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[2])) << UInt16_2))
            + ((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[3])) & UInt16_31) << UInt16_11));
        m31 offset1_col4 = m31{offset1_tmp_3fa46_3};
        traces[4][row] = offset1_col4;
        // offset2
        uint16_t offset2_tmp_3fa46_4 =
            (((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[3])) >> UInt16_5)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[4])) << UInt16_4))
            + ((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) & UInt16_7) << UInt16_13));
        m31 offset2_col5 = m31{offset2_tmp_3fa46_4};
        traces[5][row] = offset2_col5;
        // dst_base_fp
        uint16_t dst_base_fp_tmp_3fa46_5 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[6])) << UInt16_6))
            >> UInt16_0) & UInt16_1);
        m31 dst_base_fp_col6 = m31{dst_base_fp_tmp_3fa46_5};
        traces[6][row] = dst_base_fp_col6;
        // op0_base_fp
        uint16_t op0_base_fp_tmp_3fa46_6 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[6])) << UInt16_6))
            >> UInt16_1) & UInt16_1);
        m31 op0_base_fp_col7 = m31{op0_base_fp_tmp_3fa46_6};
        traces[7][row] = op0_base_fp_col7;
        // op1_imm
        uint16_t op1_imm_tmp_3fa46_7 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[6])) << UInt16_6))
            >> UInt16_2) & UInt16_1);
        m31 op1_imm_col8 = m31{op1_imm_tmp_3fa46_7};
        traces[8][row] = op1_imm_col8;
        // op1_base_fp
        uint16_t op1_base_fp_tmp_3fa46_8 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[6])) << UInt16_6))
            >> UInt16_3) & UInt16_1);
        m31 op1_base_fp_col9 = m31{op1_base_fp_tmp_3fa46_8};
        traces[9][row] = op1_base_fp_col9;
        // ap_update_add_1
        uint16_t ap_update_add_1_tmp_3fa46_9 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_3fa46_1[6])) << UInt16_6))
            >> UInt16_11) & UInt16_1);
        m31 ap_update_add_1_col10 = m31{ap_update_add_1_tmp_3fa46_9};
        ...
        // === decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10 ===
        m31 decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[3] = {
            sub(offset0_col3, M31_32768),
            sub(offset1_col4, M31_32768),
            sub(offset2_col5, M31_32768)
        };
        m31 decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_1[15] = {
            dst_base_fp_col6,
            op0_base_fp_col7,
            op1_imm_col8,
            op1_base_fp_col9,
        ...
        m31 decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_2 = M31_0;
        // === mem_dst_base_col11 ===
        m31 mem_dst_base_col11 = add(
            mul(dst_base_fp_col6, input_fp_col2),
            mul(sub(M31_1, dst_base_fp_col6), input_col1)
        );
        ...
        m31 mem0_base_col12 = add(
            ...
            mul(sub(M31_1, op0_base_fp_col7), input_col1)
        );
        ...
        m31 mem1_base_col13 = add(
            ...
            mul(decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_1[4], input_col1)
        );
        traces[13][row] = mem1_base_col13;
        // === Read Positive Num Bits 252 for dst ===
        m31 memory_address_to_id_value_tmp_3fa46_11 = {0};
        memory_address_to_id_deduce_output(
            memory_address_to_id_address_to_raw_id,
            add(mem_dst_base_col11, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[0]),
            &memory_address_to_id_value_tmp_3fa46_11
        );
        m31 memory_id_to_big_value_tmp_3fa46_12[N_M31_IN_FELT252] = {0};
        memory_id_to_big_state_deduce_output(
            memory_id_to_big_transpose_big_value_ptr,
            memory_id_to_big_small_value_ptr,
            memory_address_to_id_value_tmp_3fa46_11,
        ...
        m31 dst_id_col14 = memory_address_to_id_value_tmp_3fa46_11;
        ...
        for (int i = 0; i < 28; ++i) {
            traces[15 + i][row] = memory_id_to_big_value_tmp_3fa46_12[i];
            lookup_memory_id_to_big_0[0 * 29 + 1 + i][row] = memory_id_to_big_value_tmp_3fa46_12[i];
        }
        sub_componet_inputs_memory_id_to_big[0][row] = dst_id_col14;
        lookup_memory_id_to_big_0[0 * 29 + 0][row] = dst_id_col14;
        // === Read Positive Num Bits 252 for op0 ===
        m31 memory_address_to_id_value_tmp_3fa46_14 = {0};
        memory_address_to_id_deduce_output(
            memory_address_to_id_address_to_raw_id,
            add(mem0_base_col12, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[1]),
            &memory_address_to_id_value_tmp_3fa46_14
        );
        m31 memory_id_to_big_value_tmp_3fa46_15[N_M31_IN_FELT252] = {0};
        memory_id_to_big_state_deduce_output(
            memory_id_to_big_transpose_big_value_ptr,
            memory_id_to_big_small_value_ptr,
            memory_address_to_id_value_tmp_3fa46_14,
            memory_id_to_big_value_tmp_3fa46_15
        );
        m31 op0_id_col43 = memory_address_to_id_value_tmp_3fa46_14;
        traces[43][row] = op0_id_col43;
        sub_componet_inputs_memory_address_to_id[1][row] =
            add(mem0_base_col12, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[1]);
        lookup_memory_address_to_id_1[0 * 2 + 0][row] =
            add(mem0_base_col12, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[1]);
        lookup_memory_address_to_id_1[0 * 2 + 1][row] = op0_id_col43;

        for (int i = 0; i < 28; ++i) {
            traces[44 + i][row] = memory_id_to_big_value_tmp_3fa46_15[i];
            lookup_memory_id_to_big_1[0 * 29 + 1 + i][row] = memory_id_to_big_value_tmp_3fa46_15[i];
        }
        sub_componet_inputs_memory_id_to_big[1][row] = op0_id_col43;
        lookup_memory_id_to_big_1[0 * 29 + 0][row] = op0_id_col43;

        // === Read Positive Num Bits 252 for op1 ===
        m31 memory_address_to_id_value_tmp_3fa46_17 = {0};
        memory_address_to_id_deduce_output(
            memory_address_to_id_address_to_raw_id,
            add(mem1_base_col13, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[2]),
            &memory_address_to_id_value_tmp_3fa46_17
        );
        m31 memory_id_to_big_value_tmp_3fa46_18[N_M31_IN_FELT252] = {0};
        memory_id_to_big_state_deduce_output(
            memory_id_to_big_transpose_big_value_ptr,
            memory_id_to_big_small_value_ptr,
            memory_address_to_id_value_tmp_3fa46_17,
            memory_id_to_big_value_tmp_3fa46_18
        );
        m31 op1_id_col72 = memory_address_to_id_value_tmp_3fa46_17;
        traces[72][row] = op1_id_col72;
        sub_componet_inputs_memory_address_to_id[2][row] =
            add(mem1_base_col13, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[2]);
        lookup_memory_address_to_id_2[0 * 2 + 0][row] =
            add(mem1_base_col13, decode_instruction_5738317e55ddadf7_output_tmp_3fa46_10_0[2]);
        lookup_memory_address_to_id_2[0 * 2 + 1][row] = op1_id_col72;

        for (int i = 0; i < 28; ++i) {
            traces[73 + i][row] = memory_id_to_big_value_tmp_3fa46_18[i];
            lookup_memory_id_to_big_2[0 * 29 + 1 + i][row] = memory_id_to_big_value_tmp_3fa46_18[i];
        }
        sub_componet_inputs_memory_id_to_big[2][row] = op1_id_col72;
        lookup_memory_id_to_big_2[0 * 29 + 0][row] = op1_id_col72;

        // === Verify Add 252 ===
        uint16_t sub_p_bit_tmp_3fa46_20 =
            (UInt16_1 & (((uint16_t)traces[44][row]) ^ ((uint16_t)traces[73][row]) ^ ((uint16_t)traces[15][row])));
        m31 sub_p_bit_col101 = m31{sub_p_bit_tmp_3fa46_20};
        traces[101][row] = sub_p_bit_col101;
        // === lookup_data.opcodes_0/1 ===
        lookup_opcodes_0[0 * 3 + 0][row] = input_pc_col0;
        lookup_opcodes_0[0 * 3 + 1][row] = input_col1;
        lookup_opcodes_0[0 * 3 + 2][row] = input_fp_col2;

        lookup_opcodes_1[0 * 3 + 0][row] = add(add(input_pc_col0, M31_1), op1_imm_col8);
        lookup_opcodes_1[0 * 3 + 1][row] = add(input_col1, ap_update_add_1_col10);
...
void generate_add_opcode_traces(
    ...
    m31 **device_traces = clone_to_device<m31*>(traces, ADD_OPCODE_N_TRACE_COLUMNS);
    ...
    int block_dim = trace_size < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX;
    int num_blocks = block_dim < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;

    generate_add_opcode_trace_kernel<<<num_blocks, block_dim>>>(
        device_traces,
    ...
    cuda_free_memory(device_add_opcode_input);
    cuda_free_memory(device_memory_id_to_big_transpose_big_value_ptr);
}

template <int N, int M>
__launch_bounds__(256, 2)
__global__ void generate_add_opcode_interaction_trace_col_gen_kernel_round0(
...
template <int N, int M>
__launch_bounds__(256, 2)
__global__ void generate_add_opcode_interaction_trace_col_gen_kernel(
    LookupElementsBasic<N>  *lookup_elements_n,
    LookupElementsBasic<M>  *lookup_elements_m,
    m31 **lookup_state_0,
    m31 **lookup_state_1,
...
template <int N, int M>
__launch_bounds__(256, 2)
__global__ void generate_add_opcode_interaction_trace_col_gen_kernel_second2last(
    LookupElementsBasic<N>  *lookup_elements_n,
    LookupElementsBasic<M>  *lookup_elements_m,
    m31 **lookup_state_0,
    m31 **lookup_state_1,
...
template <int N>
__launch_bounds__(256, 2)
__global__ void generate_add_opcode_interaction_trace_col_gen_kernel_last(
    LookupElementsBasic<N>  *lookup_elements_n,
    m31 **lookup_state_0,
    unsigned trace_size,
    qm31 *denom_ptr,
...
__global__ void generate_add_opcode_interaction_trace_finalize_col_kernel(
    unsigned rep_index,
    unsigned trace_size,
    qm31 *denom_inv_ptr,
    m31 *numerator0,
...
__global__ void generate_add_opcode_interaction_trace_cumsum_shift(
    unsigned last_index,
    unsigned trace_size,
...
__global__ void generate_add_opcode_interaction_trace_coord_prefix_sum(
    m31 *coordinate_sums,
    unsigned last_index,
    unsigned trace_size,
    m31 **interactive_traces
...
void generate_add_opcode_interaction_traces(
    ...
    m31 **device_interaction_traces = clone_to_device<m31*>(interaction_traces, 4 * ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS);
    ...
    block_dim = trace_size < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;

    // #0 Interaction trace For verify_instruction_0 & memory_address_to_id_0
    generate_add_opcode_interaction_trace_col_gen_kernel_round0<7, 2><<<num_blocks, block_dim>>>(
    ...
    generate_add_opcode_interaction_trace_finalize_col_kernel<<<num_blocks, block_dim>>>(
        0,
        trace_size,
        denom_inv,
        device_numerator0,
    ...
    block_dim = trace_size < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_add_opcode_interaction_trace_col_gen_kernel<29, 2><<<num_blocks, block_dim>>>(
    ...
    block_dim = trace_size < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_add_opcode_interaction_trace_col_gen_kernel_second2last<29, 3><<<num_blocks, block_dim>>>(
        device_memory_id_to_big_lookup_elements,
    ...
    block_dim = trace_size < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? trace_size : ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ADD_OPCODE_TRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_add_opcode_interaction_trace_col_gen_kernel_last<3><<<num_blocks, block_dim>>>(
        device_opcodes_lookup_elements,
    ...
    generate_add_opcode_interaction_trace_cumsum_shift<<<num_blocks, block_dim, shared_size>>>(
        ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS,
        trace_size,
        device_interaction_traces,
        claimed_sum
    );
    ...
    block_dim = trace_size < THREAD_COUNT_MAX ? trace_size : THREAD_COUNT_MAX;
    num_blocks = block_dim < THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_add_opcode_interaction_trace_coord_prefix_sum<<<num_blocks, block_dim>>>(
        claimed_sum,
        ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS,
        trace_size,
        device_interaction_traces
    ...
    inclusive_prefix_sum(interaction_traces[4 * ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS - 4], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS - 3], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS - 2], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ADD_OPCODE_N_INTERACTION_TRACE_COLUMNS - 1], trace_size);
