...
#include "gen_assert_eq_opcode_trace.cuh"
#include "gen_memory_address_to_id_trace.cuh"
#include "gen_memory_id_to_big_trace.cuh"

#define ASSERT_EQ_OPCODEN_TRACE_COLUMNS 12

#define ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS 3

__launch_bounds__(256, 2)
__global__ void generate_assert_eq_opcode_trace_kernel(
    m31 **traces,
    ...
    if (row < trace_size) {
        ...
        m31 input_fp_col2 = assert_eq_opcode_inputs[2][row];
        traces[2][row] = input_fp_col2;
        Enabler enabler_col = Enabler(trace_size);

        // === Decode Instruction ===
        m31 memory_address_to_id_value_tmp_d6f03_0 = {0};
        memory_address_to_id_deduce_output(
            memory_address_to_id_address_to_raw_id,
            input_pc_col0,
            &memory_address_to_id_value_tmp_d6f03_0
        );
        m31 memory_id_to_big_value_tmp_d6f03_1[N_M31_IN_FELT252] = {0};
        memory_id_to_big_state_deduce_output(
            memory_id_to_big_transpose_big_value_ptr,
            memory_id_to_big_small_value_ptr,
            memory_address_to_id_value_tmp_d6f03_0,
            memory_id_to_big_value_tmp_d6f03_1
        );
        // offset0
        uint16_t offset0_tmp_d6f03_2 =
            ((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[0]))
            + ((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[1]) & UInt16_127)) << UInt16_9);
        m31 offset0_col3 = m31{offset0_tmp_d6f03_2};
        traces[3][row] = offset0_col3;
        // offset2
        uint16_t offset2_tmp_d6f03_3 =
            (((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[3])) >> UInt16_5)
            + (((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[4])) << UInt16_4))
            + ((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[5])) & UInt16_7) << UInt16_13));
        m31 offset2_col4 = m31{offset2_tmp_d6f03_3};
        traces[4][row] = offset2_col4;
        // dst_base_fp
        uint16_t dst_base_fp_tmp_d6f03_4 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[6])) << UInt16_6))
            >> UInt16_0) & UInt16_1);
        m31 dst_base_fp_col5 = m31{dst_base_fp_tmp_d6f03_4};
        traces[5][row] = dst_base_fp_col5;
        // op1_base_fp
        uint16_t op1_base_fp_tmp_d6f03_5 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[6])) << UInt16_6))
            >> UInt16_3) & UInt16_1);
        m31 op1_base_fp_col6 = m31{op1_base_fp_tmp_d6f03_5};
        traces[6][row] = op1_base_fp_col6;
        // ap_update_add_1
        uint16_t ap_update_add_1_tmp_d6f03_6 =
            ((((((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[5])) >> UInt16_3)
            + (((uint16_t)(memory_id_to_big_value_tmp_d6f03_1[6])) << UInt16_6))
            >> UInt16_11) & UInt16_1);
        m31 ap_update_add_1_col7 = m31{ap_update_add_1_tmp_d6f03_6};
        traces[7][row] = ap_update_add_1_col7;
        ...
        sub_component_inputs_verify_instruction[0 * 7 + 3][row] = offset2_col4;
        sub_component_inputs_verify_instruction[0 * 7 + 4][row] =
            add(
                add(
                    mul(dst_base_fp_col5, M31_8),
                    M31_16
                ),
                add(
                    mul(op1_base_fp_col6, M31_64),
                    mul(sub(M31_1, op1_base_fp_col6), M31_128)
                )
            );
        sub_component_inputs_verify_instruction[0 * 7 + 5][row] =
            add(mul(ap_update_add_1_col7, M31_32), M31_256);
        ...
        lookup_verify_instruction_0[0 * 7 + 3][row] = offset2_col4;
        ...
        // === decode_instruction_8779984a10576d8_output_tmp_d6f03_7 ===
        m31 decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[3] = {
            sub(offset0_col3, M31_32768),
            M31_2147483646,
            sub(offset2_col4, M31_32768)
        };
        m31 decode_instruction_8779984a10576d8_output_tmp_d6f03_7_1[15] = {
            dst_base_fp_col5,
            M31_1,
            M31_0,
            op1_base_fp_col6,
            sub(M31_1, op1_base_fp_col6),
            M31_0,
            M31_0,
            M31_0,
            M31_0,
        ...
        m31 decode_instruction_8779984a10576d8_output_tmp_d6f03_7_2 = M31_0;

        // === mem_dst_base_col8 ===
        m31 mem_dst_base_col8 = add(
            mul(dst_base_fp_col5, input_fp_col2),
            mul(sub(M31_1, dst_base_fp_col5), input_ap_col1)
        );
        traces[8][row] = mem_dst_base_col8;

        // === mem1_base_col9 ===
        m31 mem1_base_col9 = add(
            mul(op1_base_fp_col6, input_fp_col2),
            mul(decode_instruction_8779984a10576d8_output_tmp_d6f03_7_1[4], input_ap_col1)
        );
        traces[9][row] = mem1_base_col9;

        // === Mem Verify Equal ===
        m31 memory_address_to_id_value_tmp_d6f03_8 = {0};
        memory_address_to_id_deduce_output(
            memory_address_to_id_address_to_raw_id,
            add(mem_dst_base_col8, decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[0]),
            &memory_address_to_id_value_tmp_d6f03_8
        );
        m31 dst_id_col10 = memory_address_to_id_value_tmp_d6f03_8;
        traces[10][row] = dst_id_col10;
        sub_component_inputs_memory_address_to_id[0][row] = add(mem_dst_base_col8, decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[0]);
        lookup_memory_address_to_id_0[0 * 2 + 0][row] = add(mem_dst_base_col8, decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[0]);
        lookup_memory_address_to_id_0[0 * 2 + 1][row] = dst_id_col10;

        sub_component_inputs_memory_address_to_id[1][row] = add(mem1_base_col9, decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[2]);
        lookup_memory_address_to_id_1[0 * 2 + 0][row] = add(mem1_base_col9, decode_instruction_8779984a10576d8_output_tmp_d6f03_7_0[2]);
        lookup_memory_address_to_id_1[0 * 2 + 1][row] = dst_id_col10;
        ...
        lookup_opcodes_1[0 * 3 + 1][row] = add(input_ap_col1, ap_update_add_1_col7);
...
void generate_assert_eq_opcode_traces(
    m31 **traces,
    ...
    m31 **device_traces = clone_to_device<m31*>(traces, ASSERT_EQ_OPCODEN_TRACE_COLUMNS);
    ...
    int block_dim = trace_size < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? trace_size : ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX;
    int num_blocks = block_dim < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;

    generate_assert_eq_opcode_trace_kernel<<<num_blocks, block_dim>>>(
        device_traces,
    ...
    global_timer.end("generate assert_eq_opcode base trace");
    ...
    cuda_free_memory(device_assert_eq_opcode_input);
    cuda_free_memory(device_memory_id_to_big_transpose_big_value_ptr);
}

template <int N, int M>
__launch_bounds__(256, 2)
__global__ void generate_assert_eq_opcode_interaction_trace_col_gen_kernel_round0(
...
template <int N, int M>
__launch_bounds__(256, 2)
__global__ void generate_assert_eq_opcode_interaction_trace_col_gen_kernel_second2last(
    LookupElementsBasic<N>  *lookup_elements_n,
    LookupElementsBasic<M>  *lookup_elements_m,
    m31 **lookup_state_0,
    m31 **lookup_state_1,
...
template <int N>
__launch_bounds__(256, 2)
__global__ void generate_assert_eq_opcode_interaction_trace_col_gen_kernel_last(
    LookupElementsBasic<N>  *lookup_elements_n,
    m31 **lookup_state_0,
    unsigned trace_size,
    qm31 *denom_ptr,
...
__global__ void generate_assert_eq_opcode_interaction_trace_finalize_col_kernel(
    unsigned rep_index,
    unsigned trace_size,
    qm31 *denom_inv_ptr,
    m31 *numerator0,
...
__global__ void generate_assert_eq_opcode_interaction_trace_cumsum_shift(
    unsigned last_index,
    unsigned trace_size,
...
__global__ void generate_assert_eq_opcode_interaction_trace_coord_prefix_sum(
    m31 *coordinate_sums,
    unsigned last_index,
    unsigned trace_size,
    m31 **interactive_traces
...
void generate_assert_eq_opcode_interaction_traces(
    ...
    m31 **device_interaction_traces = clone_to_device<m31*>(interaction_traces, 4 * ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS);
    ...
    timer global_timer;
    global_timer.start("generate assert_eq_opcode interaction trace");

    int block_dim = 0;
    int num_blocks = 0;

    block_dim = trace_size < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? trace_size : ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;

    // #0 Interaction trace For verify_instruction_0 & memory_address_to_id_0
    generate_assert_eq_opcode_interaction_trace_col_gen_kernel_round0<7, 2><<<num_blocks, block_dim>>>(
    ...
    generate_assert_eq_opcode_interaction_trace_finalize_col_kernel<<<num_blocks, block_dim>>>(
        0,
        trace_size,
        denom_inv,
        device_numerator0,
    ...
    block_dim = trace_size < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? trace_size : ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_assert_eq_opcode_interaction_trace_col_gen_kernel_second2last<2, 3><<<num_blocks, block_dim>>>(
        device_memory_address_to_id_lookup_elements,
    ...
    block_dim = trace_size < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? trace_size : ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX;
    num_blocks = block_dim < ASSERT_EQ_OPCODETRACE_GEN_THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_assert_eq_opcode_interaction_trace_col_gen_kernel_last<3><<<num_blocks, block_dim>>>(
        device_opcodes_lookup_elements,
    ...
    generate_assert_eq_opcode_interaction_trace_cumsum_shift<<<num_blocks, block_dim, shared_size>>>(
        ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS,
        trace_size,
        device_interaction_traces,
        claimed_sum
    );
    ...
    block_dim = trace_size < THREAD_COUNT_MAX ? trace_size : THREAD_COUNT_MAX;
    num_blocks = block_dim < THREAD_COUNT_MAX ? 1 : (trace_size + block_dim - 1) / block_dim;
    generate_assert_eq_opcode_interaction_trace_coord_prefix_sum<<<num_blocks, block_dim>>>(
        claimed_sum,
        ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS,
        trace_size,
        device_interaction_traces
    ...
    inclusive_prefix_sum(interaction_traces[4 * ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS - 4], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS - 3], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS - 2], trace_size);
    inclusive_prefix_sum(interaction_traces[4 * ASSERT_EQ_OPCODEN_INTERACTION_TRACE_COLUMNS - 1], trace_size);

    global_timer.end("generate assert_eq_opcode interaction trace");
