...
void evaluate_poseidon_round_keys(
    ...
    if (use_assert_evaluator) {
        evaluate_poseidon_round_keys_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_poseidon_round_keys_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace0_evaluations,
            device_trace1_evaluations,
            random_coeff_powers,
