...
void evaluate_poseidon_full_round_chain(
    ...
    if (use_assert_evaluator) {
        evaluate_poseidon_full_round_chain_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_poseidon_full_round_chain_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace1_evaluations,
            random_coeff_powers,
            domain_log_size,
