...
#define RANGE_CHECK_7_2_5_THREAD_COUNT_MAX 256

// Corresponds to CPU AIR range_check_7_2_5.rs:
// - 3 RangeCheck preprocessed columns
// - 1 multiplicity column

template<typename EvaluatorT>
__launch_bounds__(256, 2)
__global__ void evaluate_range_check_7_2_5_pre_kernel(
    qm31 *numerators,
    ...
    RangeCheck_7_2_5_Eval *range_eval,
    qm31 cumsum_shift,
    ...
    // Layout: first 3 columns are preprocessed columns, followed by 1 multiplicity column
...
void evaluate_range_check_7_2_5(
    ...
    RangeCheck_7_2_5_Eval *range_eval =
        (RangeCheck_7_2_5_Eval *) eval;
    unsigned int eval_domain_size = 1u << eval_domain_log_size;

    // trace0: preprocessed columns, trace1: multiplicity
    ...
    RangeCheck_7_2_5_Eval *device_range_eval =
        cuda_malloc<RangeCheck_7_2_5_Eval>(1);
    cuda_mem_copy_host_to_device<RangeCheck_7_2_5_Eval>(
    ...
    timer global_timer;
    global_timer.start("evaluate_range_check_7_2_5");

    int block_dim = eval_domain_size < RANGE_CHECK_7_2_5_THREAD_COUNT_MAX
        ? eval_domain_size
        : RANGE_CHECK_7_2_5_THREAD_COUNT_MAX;
    int num_blocks = (eval_domain_size + block_dim - 1) / block_dim;

    if (use_assert_evaluator) {
        evaluate_range_check_7_2_5_pre_kernel<CudaAssertEvaluator><<<
        ...
        evaluate_range_check_7_2_5_pre_kernel<CudaEvaluator><<<
            num_blocks, block_dim>>>(
            numerators,
            device_trace0_evaluations,
            device_trace1_evaluations,
    ...
    ASSERT_CUDA_SUCCESS(cudaDeviceSynchronize());
    ASSERT_CUDA_SUCCESS(cudaGetLastError());
    global_timer.end("evaluate_range_check_7_2_5");
