...
// NOTE:
// This implementation is consistent with CPU AIR component
//   stwo_cairo_prover/crates/cairo-air/src/components/range_check_3_3_3_3_3.rs
// Logic:
// - Read 5 preprocessed columns RangeCheck::new([3,3,3,3,3], i).id()
// - Read one trace column for multiplicity
//   - add_to_relation(RangeCheck_3_3_3_3_3, -multiplicity, [v0..v4])
//   - finalize_logup_in_pairs()
//
// CUDA side provides the same row behavior via CudaEvaluator.

#define RANGE_CHECK_3_3_3_3_3_THREAD_COUNT_MAX 256

template<typename EvaluatorT>
__launch_bounds__(256, 2)
__global__ void evaluate_range_check_3_3_3_3_3_pre_kernel(
    qm31 *numerators,
    ...
    RangeCheck_3_3_3_3_3_Eval *range_eval,
    qm31 cumsum_shift,
    ...
    // Layout convention:
    // - First 5 columns are preprocessed columns (range_check_3_3_3_3_3_0..4)
    // - Followed by 1 multiplicity trace column

    m31 range0 = cuda_evaluator0.next_trace_mask();
    m31 range1 = cuda_evaluator0.next_trace_mask();
    m31 range2 = cuda_evaluator0.next_trace_mask();
    m31 range3 = cuda_evaluator0.next_trace_mask();
...
void evaluate_range_check_3_3_3_3_3(
    ...
    RangeCheck_3_3_3_3_3_Eval *range_eval =
        (RangeCheck_3_3_3_3_3_Eval *) eval;
    unsigned int eval_domain_size = 1u << eval_domain_log_size;

    // Combine preprocessed columns (trace0) and multiplicity columns (trace1) together
    // for CudaEvaluator to read in order.
    ...
    RangeCheck_3_3_3_3_3_Eval *device_range_eval =
        cuda_malloc<RangeCheck_3_3_3_3_3_Eval>(1);
    cuda_mem_copy_host_to_device<RangeCheck_3_3_3_3_3_Eval>(
    ...
    timer global_timer;
    global_timer.start("evaluate_range_check_3_3_3_3_3");

    int block_dim = eval_domain_size < RANGE_CHECK_3_3_3_3_3_THREAD_COUNT_MAX
        ? eval_domain_size
        : RANGE_CHECK_3_3_3_3_3_THREAD_COUNT_MAX;
    int num_blocks = (eval_domain_size + block_dim - 1) / block_dim;

    if (use_assert_evaluator) {
        evaluate_range_check_3_3_3_3_3_pre_kernel<CudaAssertEvaluator><<<
        ...
        evaluate_range_check_3_3_3_3_3_pre_kernel<CudaEvaluator><<<
            num_blocks, block_dim>>>(
            numerators,
            device_trace0_evaluations,
            device_trace1_evaluations,
    ...
    // Use generic post-kernel + finalize.
    ...
    generic_constraint_quotients_finalize_kernel<<<num_blocks, block_dim>>>(
        quotients_0,
        quotients_1,
        quotients_2,
        quotients_3,
    ...
    ASSERT_CUDA_SUCCESS(cudaDeviceSynchronize());
    ASSERT_CUDA_SUCCESS(cudaGetLastError());
    global_timer.end("evaluate_range_check_3_3_3_3_3");
