#ifndef EVALUATE_MUL_OPCODE_SMALL_H
#define EVALUATE_MUL_OPCODE_SMALL_H
...
struct MulOpcodeSmall_Claim {
    unsigned log_size;
};

struct MulOpcodeSmall_Eval {
    unsigned eval_id;
    MulOpcodeSmall_Claim Claim;
...
#endif // EVALUATE_MUL_OPCODE_SMALL_H
