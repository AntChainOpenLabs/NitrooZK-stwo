...
void evaluate_qm_31_add_mul_opcode(
    ...
    if (use_assert_evaluator) {
        evaluate_qm_31_add_mul_opcode_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_qm_31_add_mul_opcode_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace1_evaluations,
            random_coeff_powers,
            domain_log_size,
