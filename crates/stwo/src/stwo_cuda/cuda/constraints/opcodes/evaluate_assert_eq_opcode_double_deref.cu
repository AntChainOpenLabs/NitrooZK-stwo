...
void evaluate_assert_eq_opcode_double_deref(
    ...
    if (use_assert_evaluator) {
        evaluate_assert_eq_double_deref_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_assert_eq_double_deref_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace1_evaluations,
            random_coeff_powers,
            domain_log_size,
