...
__global__ void evaluate_jump_opcode_double_deref_pre_kernel(
    ...
    evaluate_decode_instruction_9bd86(
        ...
        decode_output,
        jump_opcode_double_deref_eval->verify_instruction_lookup_elements,
        &cuda_evaluator
    );
    ...
    evaluate_read_positive_num_bits_29(
        ...
        jump_opcode_double_deref_eval->memory_address_to_id_lookup_elements,
        jump_opcode_double_deref_eval->memory_id_to_big_lookup_elements,
        &cuda_evaluator
    );
    ...
    // Add first opcodes relation entry (positive)
    {
        ...
        RelationEntry<3> entry(
            jump_opcode_double_deref_eval->opcode_lookup_elements,
...
void evaluate_jump_opcode_double_deref(
    ...
    if (use_assert_evaluator) {
        evaluate_jump_opcode_double_deref_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_jump_opcode_double_deref_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace1_evaluations,
            random_coeff_powers,
            domain_log_size,
