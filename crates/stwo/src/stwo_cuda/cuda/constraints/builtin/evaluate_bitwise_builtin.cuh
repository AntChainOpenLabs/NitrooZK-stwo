#ifndef EVALUATE_BITWISE_BUILTIN_H
#define EVALUATE_BITWISE_BUILTIN_H
...
struct BitwiseBuiltin_Claim {
    unsigned log_size;
    unsigned bitwise_builtin_segment_start;
};
...
#endif // EVALUATE_BITWISE_BUILTIN_H
