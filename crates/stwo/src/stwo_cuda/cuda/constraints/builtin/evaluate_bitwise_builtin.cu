...
__global__ void evaluate_bitwise_builtin_pre_kernel(
    ...
    {
        m31 op0_address = m31(bitwise_eval->Claim.bitwise_builtin_segment_start) + (seq * M31_5);
    ...
    {
        m31 op1_address = m31(bitwise_eval->Claim.bitwise_builtin_segment_start) + (seq * M31_5) + M31_1;
    ...
    {
        m31 and_address = m31(bitwise_eval->Claim.bitwise_builtin_segment_start) + (seq * M31_5) + M31_2;
    ...
    {
        m31 xor_address = m31(bitwise_eval->Claim.bitwise_builtin_segment_start) + (seq * M31_5) + m31(3);
    ...
    {
        m31 or_address = m31(bitwise_eval->Claim.bitwise_builtin_segment_start) + (seq * M31_5) + m31(4);
...
void evaluate_bitwise_builtin(
    ...
    if (use_assert_evaluator) {
        evaluate_bitwise_builtin_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_bitwise_builtin_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace0_evaluations,
            device_trace1_evaluations,
            random_coeff_powers,
    ...
    if (use_assert_evaluator) {
        ...
        generic_constraint_post_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            d_intermediate_fractions,
            constraint_index_array,
            device_trace2_evaluations,
