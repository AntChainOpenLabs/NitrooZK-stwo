#ifndef EVALUATE_ADD_MOD_BUILTIN_H
#define EVALUATE_ADD_MOD_BUILTIN_H
...
struct AddModBuiltin_Claim {
    unsigned log_size;
    unsigned add_mod_builtin_segment_start;
};
...
#endif // EVALUATE_ADD_MOD_BUILTIN_H
