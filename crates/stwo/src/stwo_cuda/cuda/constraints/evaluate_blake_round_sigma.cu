...
extern "C" void evaluate_blake_round_sigma(
    ...
    if (use_assert_evaluator) {
        evaluate_blake_round_sigma_pre_kernel<CudaAssertEvaluator><<<num_blocks, block_dim>>>(
            numerators,
        ...
        evaluate_blake_round_sigma_pre_kernel<CudaEvaluator><<<num_blocks, block_dim>>>(
            numerators,
            device_trace0_evaluations,
            device_trace1_evaluations,
            random_coeff_powers,
